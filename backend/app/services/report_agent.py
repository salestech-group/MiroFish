...
Implements ReACT-style simulation report generation using LangChain + Graphiti.

Features:
1. Generate a report from the simulation requirement and the knowledge graph.
...
from .graph_retrieval_tools import (
    GraphToolsService,
    SearchResult,
    InsightForgeResult,
    PanoramaResult,
...
class ReportConsoleLogger:
    ...
    def _setup_file_handler(self):
        ...
        loggers_to_attach = [
            ...
            'mirofish.graph_retrieval_tools',
        ]
...
class ReportAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            graph_tools: Optional graph retrieval tools service.
        """
